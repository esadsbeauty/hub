...
begin
 ...
 internal_occurrences as(
  ...
  from public.calendar_events e cross join days d where e.organization_id=tenant and(responsible_filter is null or e.responsible_user_id=responsible_filter)and d.calendar_day>=((e.start_at at time zone zone)::date)and(e.recurrence_until is null or d.calendar_day<=e.recurrence_until)and(
