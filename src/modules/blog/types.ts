...
export type BlogPost = {
  ...
  categoryId?: string; categoryName?: string; categorySlug?: string; status: BlogStatus; authorId?: string;
  authorName: string; publishedAt?: string; seoTitle?: string; seoDescription?: string; createdAt?: string; updatedAt?: string;
};
export type BlogPostInput = Pick<BlogPost,"title"|"slug"|"excerpt"|"content"> & Partial<Pick<BlogPost,"id"|"coverImagePath"|"categoryId"|"seoTitle"|"seoDescription">>;
