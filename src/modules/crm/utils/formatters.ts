...
export function taskTypeLabel(value: string) { const labels: Record<string, string> = { follow_up: 'Follow-up', call: 'Ligação', whatsapp: 'WhatsApp', email: 'Email', meeting: 'Reunião', task: 'Tarefa' }; return labels[value] ?? 'Atividade'; }
