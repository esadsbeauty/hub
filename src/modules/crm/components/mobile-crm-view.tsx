...
function MobileOpportunityCard({
  ...
  return (
    <Card className="ring-1 ring-black/[.025]">
      <CardContent className="p-4">
        <button className="w-full text-left" onClick={open}>
          <h3 className="text-xl font-semibold leading-snug tracking-[-.025em]">
            {leadName}
          </h3>
        ...
        <div className="mt-3 grid grid-cols-3 gap-2 border-t pt-3">
          {whatsapp ? (
            <a
              aria-label="Abrir WhatsApp do contato"
              className="grid min-h-12 place-items-center rounded-xl bg-[#e8f7ee] text-[#176b3a] premium-focus"
              href={whatsapp}
              target="_blank"
              rel="noreferrer"
            >
