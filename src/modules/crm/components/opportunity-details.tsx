...
export function OpportunityDetails({
  ...
  const {
    ...
    handleSubmit,
    formState: { errors },
  } = useForm<LostOpportunityFormData>({
  ...
  return (
    <>
        ...
        <div className="space-y-5">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <Card>
              <CardContent className="p-4">
                ...
                <b>{currency.format(opportunity.value)}</b>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-4">
          ...
          <dl className="grid gap-3 text-sm sm:grid-cols-2">
            {[
              ...
              [
                "Tempo na etapa",
                `${daysSince(opportunity.stageEnteredAt)} dias`,
              ],
              [
                "Status",
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {opportunity.status === "open" && (
              <>
                <Button onClick={() => setConfirmWon(true)}>
                  Marcar como ganha
                </Button>
                <Button variant="outline" onClick={() => setLossOpen(true)}>
                  Marcar como perdida
                </Button>
              </>
            )}
          ...
          {lossOpen && (
            ...
            >
              <h3 className="font-bold">Motivo da perda</h3>
      ...
      <ConfirmDialog
        open={confirmArchive}
        title={`Arquivar “${opportunity.title}”?`}
