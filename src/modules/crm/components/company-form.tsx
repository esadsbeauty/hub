...
const defaultValues: CompanyFormData = {
  fantasyName: '', legalName: '', cnpj: '', phone: '', whatsapp: '', instagram: '', facebook: '', website: '', email: '', zipCode: '', address: '', number: '', complement: '', district: '', city: '', state: '', responsibleName: '', responsibleRole: '', employees: undefined, businessArea: '', leadSource: '', owner: 'Administrador', temperature: 'morno', priority: 'media', status: 'novo_lead', estimatedValue: 0, notes: '', tags: '',
};
