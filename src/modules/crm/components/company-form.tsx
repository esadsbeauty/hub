  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
      <div className="grid gap-3 md:grid-cols-3">
        ...
        <Input placeholder="Razão social" {...register("legalName")} />
        ...
        <Input placeholder="Site" {...register("website")} />
        ...
        <Input placeholder="Responsável" {...register("responsibleName")} />
        <Input placeholder="Cargo" {...register("responsibleRole")} />
        <Input
          type="number"
        ...
        <Input placeholder="Origem" {...register("leadSource")} />
        <Input placeholder="Responsável interno" {...register("owner")} />
