                        ...
                        <CardContent className="p-5 md:p-4">
                          ...
                          >
                            ...
                            {task && !stage.isWon && !stage.isLost && (
                              <div className="mt-3 rounded-xl border border-champagne/50 bg-champagne-soft/60 p-3 text-base md:mt-2 md:p-2.5 md:text-xs"><p className="font-semibold">Próxima ação: {task.title||"Follow-up"}</p><p className="mt-1 text-muted-foreground">{formatDateTime(task.dueAt)}</p></div>
                            )}
                          </button>
