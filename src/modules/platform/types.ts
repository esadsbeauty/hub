...
export type PlatformCharge={id:string;provider:string;externalPaymentId?:string;status:string;amountCents:number;currency:string;dueAt:string;paymentMethod:string;invoiceUrl?:string;errorMessage?:string};
