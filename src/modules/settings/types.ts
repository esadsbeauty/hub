...
export type Member = { id: string; userId: string; name: string; email: string; roleId: string; roleName: string; roleSlug: RoleSlug; status: MemberStatus; joinedAt?: string; createdAt: string };
