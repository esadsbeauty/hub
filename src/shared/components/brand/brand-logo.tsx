...
export function BrandLogo({ className, size = "md", compact = false }: BrandLogoProps) {
  return <img src="/brand/esads-beauty-logo.svg" alt="ESADS Beauty" width="640" height="240" decoding="async" className={cn("h-auto max-w-full object-contain", sizes[size], compact && "w-24", className)}/>;
}
