...
export type Authorization = { organizationId: string; organizationName: string; role: RoleSlug; permissions: Permission[]; entitlements: string[]; status: MemberStatus; isPlatformAdmin: boolean };
