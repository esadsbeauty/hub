...
export default function PublicAppRoot(){return <AppQueryProvider><BrowserRouter><Routes><Route element={<PublicLayout/>}><Route path="/blog" element={<BlogIndexPage/>}/><Route path="/blog/:slug" element={<BlogPostPage/>}/><Route path="/diagnostico" element={<DiagnosticPage/>}/><Route path="/diagnostico/resultado/:token" element={<DiagnosticPage/>}/><Route path="/privacidade" element={<LegalNoticePage/>}/><Route path="/termos" element={<LegalNoticePage/>}/></Route><Route path="*" element={<Navigate to="/diagnostico" replace/>}/></Routes></BrowserRouter></AppQueryProvider>}
