      ...
      <BrowserRouter>
        ...
        <Routes>
          <Route element={<PublicLayout />}>
            ...
            <Route
              path="/diagnostico/resultado/:token"
              element={<DiagnosticPage />}
            />
            <Route
              path="/diagnostico/obrigado/:token"
              element={<DiagnosticPage />}
            />
            <Route path="/privacidade" element={<LegalNoticePage />} />
            <Route path="/termos" element={<LegalNoticePage />} />
          </Route>
